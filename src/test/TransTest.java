...
public class TransTest {
	...
	public void test() throws Exception {
		...
		System.out.println("金山 : " + factory.get("jinshan").trans(LANG.TR, LANG.EN, origin));
		System.out.println("有道 : " + factory.get("youdao").trans(LANG.TR, LANG.EN, origin));
		System.out.println("百度 : " + factory.get("baidu").trans(LANG.TR, LANG.EN, origin));
		System.out.println("谷歌 : " + factory.get("google").trans(LANG.TR, LANG.EN, origin));
		System.out.println("腾讯 : " + factory.get("tencent").trans(LANG.Tr, LANG.EN, origin));
		System.out.println("欧米 : " + factory.get("omi").trans(LANG.TR, LANG.EN, origin));
	}
	...
	public void testTime() throws Exception {
		...
		while(true){
			cnt++;
			System.out.println(cnt+" : "+lator.trans(LANG.EN, LANG.TR, origin));
			Thread.sleep(10);
		}
	}
	*/
